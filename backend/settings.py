...
os.environ['HTTP'] = os.environ.get("HTTP", default="on")
...
if 'WEBSITE_SITE_NAME' in os.environ:
    ...
    CLIENT_HOST = 'https://lsdbwebuat.azurewebsites.net'.format(os.environ['WEBSITE_SITE_NAME'])
    EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
    EMAIL_HOST = 'smtp.office365.com'
    EMAIL_PORT = 587
    EMAIL_HOST_USER = 'support@pvel.com'
    EMAIL_HOST_PASSWORD = 'Wow78746'
    EMAIL_USE_TLS = True
    EMAIL_USE_SSL = False
else:
    ALLOWED_HOSTS = ['*']
