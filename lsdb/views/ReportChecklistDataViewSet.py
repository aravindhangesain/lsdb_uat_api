    ...
    def add_reportchecklistdata(self, request):
        ...
        # Update checklist data
            ...
            try:
                ...
                """
                for item in checklist_data:
                    checklist_obj = CheckList.objects.filter(id=item["id"]).first()
                    if checklist_obj:
                        category = checklist_obj.category if checklist_obj.category else "N/A"
                        check_point = checklist_obj.check_point
                    else:
                        category = "N/A"
                        check_point = "N/A"
