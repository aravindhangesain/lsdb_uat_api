...
from lsdb.utils.HasHistory_pichina import measurements_completed, measurements_requested


class Project_pichinaSerializer(serializers.HyperlinkedModelSerializer):
