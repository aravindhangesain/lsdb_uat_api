...
class AzureFile_pichinaSerializer(serializers.HyperlinkedModelSerializer):
    ...
    def create(self, validated_data):
        ...
        try:
            file = AzureFile_pichina.objects.get(
            ...
            file = AzureFile_pichina.objects.create(**validated_data)
        return file
