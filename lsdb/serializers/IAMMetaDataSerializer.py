...
class IAMMetaDataSerializer(serializers.ModelSerializer):
    ...
    def get_module_properties(self, obj):
        with connection.cursor() as cursor:
            ...
            cursor.execute('''
                SELECT mt.name as module_technology_name,mp.module_width,mp.module_height,mp.isc,
                           mp.cells_in_parallel,mp.cells_in_series
            ...
            return [
                {
                    ...
                    'Isc':property[3],
                    'No parallel strings in module':property[4],
                    'Number of tapped cells in series':property[5],
