...
class Limit_pichina(models.Model):
    ...
    limit_comparison_one = models.ForeignKey('LimitComparison_pichina', related_name ='limitcomparisonone', on_delete=models.CASCADE, blank=False, null=False)
    limit_comparison_two = models.ForeignKey('LimitComparison_pichina', related_name ='limitcomparisontwo', on_delete=models.CASCADE, blank=False, null=False)
    limit_comparison_mode = models.ForeignKey('LimitComparisonMode_pichina', on_delete=models.CASCADE, blank=False, null=False)
