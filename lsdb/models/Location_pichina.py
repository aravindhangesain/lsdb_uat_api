...
class Location_pichina(models.Model):
    ...
    parent_location = models.ForeignKey('Location_pichina', on_delete=models.CASCADE, related_name='child_locations', blank=True, null=True)
